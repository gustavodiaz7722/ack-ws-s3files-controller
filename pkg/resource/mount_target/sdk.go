...
func (rm *resourceManager) sdkFind(
	...
	var resp *svcsdk.GetMountTargetOutput
	resp, err = rm.sdkapi.GetMountTarget(ctx, input)
	rm.metrics.RecordAPICall("READ_ONE", "GetMountTarget", err)
	if err != nil {
	...
	if resp.Ipv4Address != nil {
		ko.Spec.IPv4Address = resp.Ipv4Address
	} else {
		ko.Spec.IPv4Address = nil
	}
	if resp.Ipv6Address != nil {
		ko.Spec.IPv6Address = resp.Ipv6Address
	} else {
...
func (rm *resourceManager) newCreateRequestPayload(
	...
	if r.ko.Spec.IPv4Address != nil {
		res.Ipv4Address = r.ko.Spec.IPv4Address
	}
	if r.ko.Spec.IPv6Address != nil {
		res.Ipv6Address = r.ko.Spec.IPv6Address
	}
...
func (rm *resourceManager) sdkUpdate(
	...
	var resp *svcsdk.UpdateMountTargetOutput
	_ = resp
	resp, err = rm.sdkapi.UpdateMountTarget(ctx, input)
	rm.metrics.RecordAPICall("UPDATE", "UpdateMountTarget", err)
	if err != nil {
		return nil, err
	}
	// Merge in the information we read from the API call above to the copy of
