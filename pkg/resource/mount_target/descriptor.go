...
const (
	FinalizerString = "finalizers.s3files.services.k8s.aws/MountTarget"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("mounttargets")
	GroupKind            = metav1.GroupKind{
		Group: "s3files.services.k8s.aws",
		Kind:  "MountTarget",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.MountTarget{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.MountTarget),
	}
}
