...
func newResourceDelta(
	...
	if ackcompare.HasNilDifference(a.ko.Spec.RootDirectory, b.ko.Spec.RootDirectory) {
		...
		if ackcompare.HasNilDifference(a.ko.Spec.RootDirectory.CreationPermissions, b.ko.Spec.RootDirectory.CreationPermissions) {
			delta.Add("Spec.RootDirectory.CreationPermissions", a.ko.Spec.RootDirectory.CreationPermissions, b.ko.Spec.RootDirectory.CreationPermissions)
		} else if a.ko.Spec.RootDirectory.CreationPermissions != nil && b.ko.Spec.RootDirectory.CreationPermissions != nil {
			if ackcompare.HasNilDifference(a.ko.Spec.RootDirectory.CreationPermissions.OwnerGID, b.ko.Spec.RootDirectory.CreationPermissions.OwnerGID) {
				delta.Add("Spec.RootDirectory.CreationPermissions.OwnerGID", a.ko.Spec.RootDirectory.CreationPermissions.OwnerGID, b.ko.Spec.RootDirectory.CreationPermissions.OwnerGID)
			} else if a.ko.Spec.RootDirectory.CreationPermissions.OwnerGID != nil && b.ko.Spec.RootDirectory.CreationPermissions.OwnerGID != nil {
				if *a.ko.Spec.RootDirectory.CreationPermissions.OwnerGID != *b.ko.Spec.RootDirectory.CreationPermissions.OwnerGID {
					delta.Add("Spec.RootDirectory.CreationPermissions.OwnerGID", a.ko.Spec.RootDirectory.CreationPermissions.OwnerGID, b.ko.Spec.RootDirectory.CreationPermissions.OwnerGID)
				}
			}
			if ackcompare.HasNilDifference(a.ko.Spec.RootDirectory.CreationPermissions.OwnerUID, b.ko.Spec.RootDirectory.CreationPermissions.OwnerUID) {
				delta.Add("Spec.RootDirectory.CreationPermissions.OwnerUID", a.ko.Spec.RootDirectory.CreationPermissions.OwnerUID, b.ko.Spec.RootDirectory.CreationPermissions.OwnerUID)
			} else if a.ko.Spec.RootDirectory.CreationPermissions.OwnerUID != nil && b.ko.Spec.RootDirectory.CreationPermissions.OwnerUID != nil {
				if *a.ko.Spec.RootDirectory.CreationPermissions.OwnerUID != *b.ko.Spec.RootDirectory.CreationPermissions.OwnerUID {
					delta.Add("Spec.RootDirectory.CreationPermissions.OwnerUID", a.ko.Spec.RootDirectory.CreationPermissions.OwnerUID, b.ko.Spec.RootDirectory.CreationPermissions.OwnerUID)
				}
			}
			if ackcompare.HasNilDifference(a.ko.Spec.RootDirectory.CreationPermissions.Permissions, b.ko.Spec.RootDirectory.CreationPermissions.Permissions) {
				delta.Add("Spec.RootDirectory.CreationPermissions.Permissions", a.ko.Spec.RootDirectory.CreationPermissions.Permissions, b.ko.Spec.RootDirectory.CreationPermissions.Permissions)
			} else if a.ko.Spec.RootDirectory.CreationPermissions.Permissions != nil && b.ko.Spec.RootDirectory.CreationPermissions.Permissions != nil {
				if *a.ko.Spec.RootDirectory.CreationPermissions.Permissions != *b.ko.Spec.RootDirectory.CreationPermissions.Permissions {
					delta.Add("Spec.RootDirectory.CreationPermissions.Permissions", a.ko.Spec.RootDirectory.CreationPermissions.Permissions, b.ko.Spec.RootDirectory.CreationPermissions.Permissions)
				}
			}
		}
