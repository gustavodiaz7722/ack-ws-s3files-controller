...
// +kubebuilder:rbac:groups=s3files.services.k8s.aws,resources=accesspoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=s3files.services.k8s.aws,resources=accesspoints/status,verbs=get;update;patch
