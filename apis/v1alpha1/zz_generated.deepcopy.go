...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CreationPermissions) DeepCopyInto(out *CreationPermissions) {
	*out = *in
	if in.OwnerGID != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CreationPermissions.
func (in *CreationPermissions) DeepCopy() *CreationPermissions {
	if in == nil {
		return nil
	}
	out := new(CreationPermissions)
	in.DeepCopyInto(out)
	return out
}
